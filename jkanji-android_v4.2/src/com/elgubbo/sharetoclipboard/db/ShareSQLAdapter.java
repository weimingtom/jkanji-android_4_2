...
public class ShareSQLAdapter extends SQLiteOpenHelper {
	...
	private final static String TAG = "ShareSQLAdapter";
	...
	public static final String HELP_CONTENT = "可使用共享方式和web搜索器插入记录。请勿使用此功能存储重要数据。";

	/** The Constant HELP_DESCRIPTION. */
	private static final String HELP_DESCRIPTION = "帮助描述：";

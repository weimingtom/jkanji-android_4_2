...
//        	if (filename != null && 
//        		((filename.startsWith("/") && new File(filename).isDirectory()) ||
//        		!filename.startsWith("/"))
//        		) {
//        		Bitmap bitmap = processBitmap(filename);
//        		if (bitmap != null) {
//        			BitmapDrawable drawable = new RecyclingBitmapDrawable(mResources, bitmap);
...
//	        }
     ...
     * @param resId
     */
    public void setLoadingImage(int resId, int resId2) {
        mLoadingBitmap = BitmapFactory.decodeResource(mResources, resId);
        mLoadingBitmapId = resId2;
    }
...
//                    new BitmapDrawable(mResources, mLoadingBitmap));
            imageView.setBackgroundResource(mLoadingBitmapId);

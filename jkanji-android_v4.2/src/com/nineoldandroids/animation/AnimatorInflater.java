...
public class AnimatorInflater {
    private static final int[] AnimatorSet = new int[] {
        /* 0 */ 16843490, //android.R.attr.ordering, //FIXME:
    };
    private static final int AnimatorSet_ordering = 0;

    private static final int[] PropertyAnimator = new int[] {
        /* 0 */ 16843489, //android.R.attr.propertyName, //FIXME:
    };
    ...
    private static final int[] Animator = new int[] {
        ...
        /* 5 */ 16843486, //android.R.attr.valueFrom, //FIXME:
        /* 6 */ 16843487, //android.R.attr.valueTo, //FIXME:
        /* 7 */ 16843488, //android.R.attr.valueType, //FIXME:
    };

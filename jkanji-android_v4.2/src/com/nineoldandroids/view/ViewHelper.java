...
public final class ViewHelper {
    ...
    public static float getAlpha(View view) {
        return NEEDS_PROXY ? wrap(view).getAlpha() : 0/*Honeycomb.getAlpha(view)*/;
    }
    ...
    public static float getPivotX(View view) {
        return NEEDS_PROXY ? wrap(view).getPivotX() : 0/*Honeycomb.getPivotX(view)*/;
    }
    ...
    public static float getPivotY(View view) {
        return NEEDS_PROXY ? wrap(view).getPivotY() : 0/*Honeycomb.getPivotY(view)*/;
    }
    ...
    public static float getRotation(View view) {
        return NEEDS_PROXY ? wrap(view).getRotation() : 0/*Honeycomb.getRotation(view)*/;
    }
    ...
    public static float getRotationX(View view) {
        return NEEDS_PROXY ? wrap(view).getRotationX() : 0/*Honeycomb.getRotationX(view)*/;
    }
    ...
    public static float getRotationY(View view) {
        return NEEDS_PROXY ? wrap(view).getRotationY() : 0/*Honeycomb.getRotationY(view)*/;
    }
    ...
    public static float getScaleX(View view) {
        return NEEDS_PROXY ? wrap(view).getScaleX() : 0/*Honeycomb.getScaleX(view)*/;
    }
    ...
    public static float getScaleY(View view) {
        return NEEDS_PROXY ? wrap(view).getScaleY() : 0/*Honeycomb.getScaleY(view)*/;
    }
    ...
    public static float getScrollX(View view) {
        return NEEDS_PROXY ? wrap(view).getScrollX() : 0/*Honeycomb.getScrollX(view)*/;
    }
    ...
    public static float getScrollY(View view) {
        return NEEDS_PROXY ? wrap(view).getScrollY() : 0/*Honeycomb.getScrollY(view)*/;
    }
    ...
    public static float getTranslationX(View view) {
        return NEEDS_PROXY ? wrap(view).getTranslationX() : 0/*Honeycomb.getTranslationX(view)*/;
    }
    ...
    public static float getTranslationY(View view) {
        return NEEDS_PROXY ? wrap(view).getTranslationY() : 0/*Honeycomb.getTranslationY(view)*/;
    }
    ...
    public static float getX(View view) {
        return NEEDS_PROXY ? wrap(view).getX() : 0/*Honeycomb.getX(view)*/;
    }
    ...
    public static float getY(View view) {
        return NEEDS_PROXY ? wrap(view).getY() : 0/*Honeycomb.getY(view)*/;
    }

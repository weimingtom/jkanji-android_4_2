...
class IcsLinearLayout extends LinearLayout {
    private static final int[] LL = new int[] {
        ...
        /* 1 */ 16843561, //android.R.attr.showDividers, //FIXME:
        /* 2 */ 16843562, //android.R.attr.dividerPadding, //FIXME:
    };
    ...
    public IcsLinearLayout(Context context, int themeAttr) {
        ...
        mShowDividers = a.getInteger(LL_SHOW_DIVIDER, 0/*SHOW_DIVIDER_NONE*/);
        a.recycle();
    }
    ...
    private boolean hasDividerBeforeChildAt(int childIndex) {
        ...
        if ((mShowDividers & 2/*SHOW_DIVIDER_MIDDLE*/) != 0) {

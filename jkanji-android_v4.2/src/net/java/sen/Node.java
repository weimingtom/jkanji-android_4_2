...
final public class Node {
  ...
  public String getPos() {
    ...
    if (termInfo.length() == 0) {
      ...
      Log.e(TAG, "token rcAttr2 = " + this.token.rcAttr2);
      Log.e(TAG, "token rcAttr1 = " + this.token.rcAttr1);
      Log.e(TAG, "token lcAttr = " + this.token.lcAttr);
      Log.e(TAG, "token length = " + this.token.length);
      Log.e(TAG, "token cost = " + this.token.cost);
      return null;
    }

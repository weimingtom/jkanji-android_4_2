...
public abstract class Tokenizer {
	...
	private final static String TAG = "Tokenizer";
  ...
  private void loadConnectCost(String connectFile) throws IOException {
    ...
    if (D) {
    	Log.d(TAG, "connection file = " + f.toString());
    }
    ...
    if (D) {
    Log.d(TAG, "msize1=" + msize1);
    Log.d(TAG, "msize2=" + msize2);
    Log.d(TAG, "msize3=" + msize3);
    Log.d(TAG, "matrix size = " + len);
    }
    ...
    if (D) {
    Log.d(TAG, "time to load connect cost file = "
